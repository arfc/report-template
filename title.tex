...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
    ...
    \vspace{0.2cm}
     \begin{minipage}{0.4\textwidth}
        ...
        {\begin{flushright}\huge\bfseries An Unnecessarily Convoluted Academic Title
                           \end{flushright}}
    ...
    {\large Month DD, YYYY} % January 1, 3000
...
%------------------------------------------------
    ...
    Department of Silly Walks, `A Very Good Project Title,' Award Number 
    NNNNNNN-NNNNNN.}
